...
export default function App() {
  ...
  useEffect(() => {
    const API_URL = import.meta.env.VITE_API_URL || 'https://mashaly10-idc-icpc.hf.space';
    ...
    fetch(`${API_URL}/api/leaderboard`)
      ...
      .then(data => {
        ...
        setUsers(arr.filter(u => u && u.handle).sort((a, b) => b.season_points - a.season_points));
      })
      .catch(err => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="mb-12 border-b border-white/10 pb-8 flex flex-col md:flex-row justify-between items-center md:items-end gap-6 text-center md:text-right">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            />
            <div>
              <h1 className="text-5xl md:text-6xl font-black text-white mb-1 tracking-tighter">IDC CPers</h1>
